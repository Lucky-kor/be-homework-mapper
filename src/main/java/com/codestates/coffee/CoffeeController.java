...
public class CoffeeController {
    ...
    public ResponseEntity postCoffee(@Valid @RequestBody CoffeePostDto coffeePostDto) {
        ...
        Coffee responseCoffee = coffeeService.createCoffee(coffee);
        CoffeeResponseDto responseDto = coffeeMapper.coffeeToCoffeeResponseDto(responseCoffee);
    ...
    public ResponseEntity patchCoffee(@PathVariable("coffee-id") @Positive long coffeeId,
        ...
        Coffee responseCoffee = coffeeService.updateCoffee(coffee);
        CoffeeResponseDto responseDto = coffeeMapper.coffeeToCoffeeResponseDto(responseCoffee);
    ...
    public ResponseEntity getCoffees() {
        ...
        List<CoffeeResponseDto> responseDtoList = coffeeMapper.coffeeToCoffeeResponseDtoList(coffeeList);
