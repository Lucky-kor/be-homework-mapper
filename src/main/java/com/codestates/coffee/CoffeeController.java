...
public class CoffeeController {
    // CoffeeService 와 연동하기 위해서 생성자를 만들어야 한다
    //의존성 주입
    ...
    public ResponseEntity postCoffee(@Valid @RequestBody CoffeePostDto coffeePostDto) {
        ...
        // TODO CoffeeService 클래스와 연동하세요. 위에서 연결
    ...
    public ResponseEntity getCoffees() {
        ...
        List<CoffeeResponseDto> responseDtos = coffeeMapper.coffeesToCoffeeResponseToDtos(response);
